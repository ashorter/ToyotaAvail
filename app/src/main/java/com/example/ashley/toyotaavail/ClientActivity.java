package com.example.ashley.toyotaavail;
...
public class ClientActivity extends AppCompatActivity implements DeviceListener, ConnectionListener {
    ...
    private static final String TOKEN_SERVICE_URL = "https://dry-ridge-55058.herokuapp.com/call";
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        clientProfile = new ClientProfile("Chris Griffin", true, true);
    ...
    private void updateClientProfileDialog() {
       // alertDialog = client.twilio.com.quickstart.Dialog.createRegisterDialog(updateTokenClickListener(), cancelCallClickListener(), clientProfile, this);
        alertDialog.show();
    }
    ...
    private void showCallDialog() {
        Object client;
       // alertDialog = client.twilio.com.quickstart.Dialog.createCallDialog(callClickListener(), cancelCallClickListener(), this);
        alertDialog.show();
    }
    ...
    private void showIncomingDialog() {
       // alertDialog = client.twilio.com.quickstart.Dialog.createIncomingCallDialog(answerCallClickListener(), cancelCallClickListener(), this);
        alertDialog.show();
    }
